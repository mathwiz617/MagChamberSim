...
MiceStats::MiceStats() {
	...
	heated =  Mouse::Mouse("Superheated", 38000, 1, 50000, 5000, .4);
	magma = Mouse::Mouse("Magma", 35000, 1, 30000, 3000, .6);
	gDragon = Mouse::Mouse("Green Dragon", 80000, 2, 50000, 50000, .3);
	rDragon = Mouse::Mouse("Red Dragon", 80000, 2, 100000, 10000, .3);
	bDragon = Mouse::Mouse("Blue Dragon", 80000, 2, 10000, 100000, .3);
